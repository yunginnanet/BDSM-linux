...
";
	...
	public static readonly ImmutableHashSet<PathMapping> DefaultPathMappingsAIS =
		ModpackNamesToPathMappings(DefaultModpackNames(false), ValidGamePath, DefaultConnectionInfo.RootPath);

	public static readonly ImmutableHashSet<PathMapping> DefaultPathMappingsHS2 =
		ModpackNamesToPathMappings(DefaultModpackNames(true), ValidGamePath, DefaultConnectionInfo.RootPath);

	// Not testing v0.1 YAML. Only testing that the upgrade logic works.

	public static readonly string[] OldConfigModpackDefaults =
	{
	...
	public static readonly string[] OldConfigModpackFull =
	{
		@"mods/Sideloader Modpack | mods/Sideloader Modpack | true",
		@"mods/Sideloader Modpack - Exclusive HS2 | mods/Sideloader Modpack - Exclusive HS2 | true",
	...
	public static readonly string[] OldConfigModpackNonDefault =
	{
		@"mods/Sideloader Modpack | mods/Sideloader Modpack | true",
		@"mods/Sideloader Modpack - Exclusive HS2 | mods/Sideloader Modpack - Exclusive HS2 | true",
		@"mods/Sideloader Modpack - Maps (HS2 Game) | mods/Sideloader Modpack - Maps (HS2 Game) | true",
	...
	{
		GamePath = ValidGamePath,
		ConnectionInfo = new RepoConnectionInfo
		{
...
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
	...
	public static readonly RawUserConfiguration RawUserConfigurationEmpty =
		new() { GamePath = null, OptionalModpacks = null, PromptToContinue = null };
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
	...
	public static readonly RawUserConfiguration RawUserConfigurationDefault = new()
	{
		GamePath         = ValidGamePath,
		OptionalModpacks = DefaultModpacksRawHS2,
		PromptToContinue = DefaultPromptToContinue
	};

	public static readonly RawUserConfiguration RawUserConfigurationCustom = RawUserConfigurationDefault with
	{
		OptionalModpacks = DefaultModpacksRawHS2 with { MEShaders = false, Exclusive = false }
	};

	public static readonly RawUserConfiguration RawUserConfiguration03Config = RawUserConfigurationDefault with
	{
		OptionalModpacks = DefaultModpacksRawHS2 with
		{
			Main = null,
			MEShaders = null,
			Exclusive = null,
			UncensorSelector = null,
			HS2Maps = null,
			StudioMaps = null
		}
	};
